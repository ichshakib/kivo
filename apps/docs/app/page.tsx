    ...
    <div className="min-h-screen bg-background text-foreground flex flex-col justify-between antialiased">
      ...
      <header className="border-b bg-card/60 backdrop-blur-md sticky top-0 z-50">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
          ...
          <Badge
            variant="outline"
            className="border-emerald-500/40 text-emerald-600 dark:text-emerald-400 gap-1.5 py-1 px-3"
          >
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 py-12 flex-1 flex flex-col items-center justify-center text-center">
        ...
        <p className="mt-4 text-base sm:text-lg text-muted-foreground max-w-xl leading-relaxed">
          Interactive documentation and components shared across all apps from{' '}
          <code className="text-xs bg-muted px-1.5 py-0.5 rounded font-mono">@repo/ui</code>.
        </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 w-full text-left mt-10">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Test different button states and sizes</CardDescription>
            </CardHeader>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Search UI documentation and components</CardDescription>
            </CardHeader>
